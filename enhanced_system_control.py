...
class NovaSystemControl:
    ...
    def open_youtube(self, query: str = None) -> str:
        ...
        try:
            if query and query.strip():
                ...
                return f"Opening YouTube and searching for '{query}'! Time to binge-watch! 🎥"
            else:
                # Just open YouTube homepage
                webbrowser.open("https://www.youtube.com")
                return "Opening YouTube! Ready for some video entertainment? 🎬"
        except Exception as e:
    ...
    def search_youtube(self, query: str) -> str:
        ...
        try:
            ...
            youtube_search_url = f"https://www.youtube.com/results?search_query={query.replace(' ', '+')}"
            webbrowser.open(youtube_search_url)
            return f"Searching YouTube for '{query}'! Hope you find something awesome! 🔍📺"
        except Exception as e:
    ...
    def create_folder(self, foldername: str) -> str:
        ...
        try:
            ...
            return f"Created folder '{foldername}' for you!"
        except Exception as e:
...
def integrate_system_control_with_nova():
    ...
    def enhanced_query_ollama(prompt, current_username, is_current_user_creator):
        ...
        if any(phrase in prompt_lower for phrase in ["open youtube", "go to youtube", "youtube"]):
...
if __name__ == "__main__":
    ...
    print(system_control.open_youtube())
    print(system_control.open_youtube("funny cats"))
